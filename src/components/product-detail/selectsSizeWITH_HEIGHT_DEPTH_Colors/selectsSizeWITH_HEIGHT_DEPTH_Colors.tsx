...
interface SelectsSizeWITH_HEIGHT_DEPTH_ColorsProps {
    product: any;
    selectedSize: any;
...
export function SelectsSizeWITH_HEIGHT_DEPTH_ColorsProps({ product, selectedSize, setSelectedSize, selectedColor, setSelectedColor }: SelectsSizeWITH_HEIGHT_DEPTH_ColorsProps) {
